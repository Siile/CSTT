...
MACRO_CONFIG_STR(SvName, sv_name, 128, "Counter-Strike: Tee Time", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "ctf4", CFGFLAG_SERVER, "Map to use on the server")
