...
MACRO_CONFIG_STR(SvName, sv_name, 128, "cs:tt dev & testing", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "kf_warehouse1", CFGFLAG_SERVER, "Map to use on the server")
